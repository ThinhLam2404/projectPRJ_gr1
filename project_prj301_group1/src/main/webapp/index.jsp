    ...
    <body>
        <div class="header">
            ...
            <div class="home">
                ...
                <div class="col-2">
                    <input style="width: 140%;border: none; outline: none;" name="mail" value="${email}" id="mail" readonly>
                </div>
                ...
                <div class="col-4 logo">
                    <div style="justify-content: center;display: flex;"><a href="home">DOTAI</a></div>
                </div>
        ...
        <div class="product ${admin}">
            <c:forEach items="${list}" var="obj2">
                ...
                <div class="col-3">
                    <a onclick="checkLogin('${obj2.getPro_id()}')" href="#" class="product-link doimau">

                        <img src="${obj2.getPro_pic()}" alt="levent">
                        <p>${obj2.pro_name}</p>
